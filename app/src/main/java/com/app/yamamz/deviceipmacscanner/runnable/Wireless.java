...
public class Wireless {
    ...
    public String getMacAddress() {
        @SuppressLint("HardwareIds") String address = this.getWifiInfo().getMacAddress(); //Won't work on Android 6+ https://developer.android.com/about/versions/marshmallow/android-6.0-changes.html#behavior-hardware-id
